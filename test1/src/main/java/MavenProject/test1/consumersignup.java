	...
	public class consumersignup {
	 ...
	 //public void signUp(){ 
	  try{
	   ...
	   System.setProperty("webdriver.gecko.driver", "E:\\seleinium1\\software\\geckodriver.exe");
	   driver = new FirefoxDriver();
	   driver.get("https://www.bayboon.com/consumer/");
	   driver.manage().window().maximize();
	   Thread.sleep(5000);
	   driver.findElement(By.id("signin-width")).click();
	   //driver.findElement(By.xpath("/html/body/div[2]/header-dir/div[2]/div/login/div/div/div/div/div/div/div/div/div[1]/div/div[2]/ul/li[2]/a")).click();
       ...
       List<WebElement> childs=(List<WebElement>) driver.findElement(By.id("commentsflag"));
